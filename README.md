...
- Резюме: обо мне, навыки, опыт, образование, контакты
- Библиотека из 47 проектов с фильтрами по типу и поиском по тегам
...
```json
{
  ...
  "links": { "github": "https://…", "demo": "#demo", "registry": "" },
...
- ссылку на свидетельство в реестре ЭВМ для проекта `quest` («Демоны молодости»)
- подробности по SDK оплаты и фриланс-проектам в `data/profile.json`
